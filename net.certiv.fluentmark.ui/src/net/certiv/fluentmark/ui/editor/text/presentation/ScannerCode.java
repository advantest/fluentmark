...
public class ScannerCode extends AbstractBufferedRuleBasedScanner implements IScannerExt {
	...
	protected String[] getTokenProperties() {
		if (tokenProperties == null) {
			tokenProperties = new String[] { Prefs.EDITOR_MARKDOWN_CODE_SPAN_COLOR, Prefs.EDITOR_MARKDOWN_CODE_BLOCK_COLOR };
		}
	...
	protected List<IRule> createRules() {
		...
		IToken block = getToken(Prefs.EDITOR_MARKDOWN_CODE_BLOCK_COLOR);
