...
public class Lines {
	...
	public Type identifyKind(int idx) {
		...
		if (priorblank && curTxt.startsWith(PlantUmlConstants.PREFIX_START)) return Type.CODE_BLOCK;
		if (nxtblank && curTxt.startsWith(PlantUmlConstants.PREFIX_END)) return Type.CODE_BLOCK;
